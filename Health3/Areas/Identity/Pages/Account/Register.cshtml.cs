...
using Health3.Data; // Importez votre contexte de base de données
using Health3.Models;
using Microsoft.AspNetCore.WebUtilities; // Importez le modèle Patient

namespace Health3.Areas.Identity.Pages.Account
{
